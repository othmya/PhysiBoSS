...
// this function is called from the main-template_BM.cpp
...
void tumor_cell_phenotype_with_signaling( Cell* pCell, Phenotype& phenotype, double dt )
{
	...
	// the functions within this IF condition are not declared anywhere?

	if (PhysiCell_globals.current_time >= pCell->custom_data.variables.at(index_next_physiboss_run).value)
	{
		set_input_nodes(pCell);

		pCell->boolean_network.run_simulation(); // was run_maboss
		// Get noisy step size
