...
{	
    ...
    if ( apoptosis ) {
        ...
        phenotype.death.rates[apoptosis_index] -= phenotype.death.rates[apoptosis_index] * 1E-9;
    ...
    if ( nonACD ) {
        ...
        phenotype.death.rates[necrosis_index] -= phenotype.death.rates[necrosis_index] * 1E-9;
