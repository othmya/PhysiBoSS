...
void drug_transport_model_setup()
{
    ...
    ags_receptor_info.main_function = drug_transport_model; 

	// what custom data do I need?
	ags_receptor_info.cell_variables.push_back( "activation_threshold" );

	// dA (Densities & kinetics)
	ags_receptor_info.cell_variables.push_back( "Initial_dA_internal" );
	...
	ags_receptor_info.cell_variables.push_back( "Initial_dB_internal" );
