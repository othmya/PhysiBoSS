...
drugs_synergy_model: 	
	cp ./sample_projects_intracellular/boolean/drugs_synergy/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects_intracellular/boolean/drugs_synergy/main.cpp ./main.cpp 
	cp Makefile Makefile-backup
	cp ./sample_projects_intracellular/boolean/drugs_synergy/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml 
	cp -r ./sample_projects_intracellular/boolean/drugs_synergy/config/* ./config/
